...
{\it Description:} [Adavanced] Uses algorithms which have lower peak memory but with a marginal performance degradation. Default: true.
...
{\it Possible values:} Any one of FE, SLATER, PW
...
{\it Possible values:} Any one of LDA-PZ, LDA-PW, LDA-VWN, GGA-PBE, GGA-RPBE, GGA-LBxPBEc, MLXC-NNLDA, MLXC-NNGGA, MLXC-NNLLMGGA, LDA-PZ+U, LDA-PW+U, LDA-VWN+U, GGA-PBE+U, GGA-RPBE+U, GGA-LBxPBEc+U, MLXC-NNLDA+U, MLXC-NNGGA+U, MLXC-NNLLMGGA+U, MGGA-SCAN, MGGA-R2SCAN
...
{\it Possible values:} A floating point number $v$ such that $-1 \leq v \leq 1$
\item {\it Parameter name:} {\tt USE ATOMIC MAGNETIZATION GUESS FOR CONSTRAINT MAG}
\phantomsection\label{parameters:DFT functional parameters/USE ATOMIC MAGNETIZATION GUESS FOR CONSTRAINT MAG}
\label{parameters:DFT_20functional_20parameters/USE_20ATOMIC_20MAGNETIZATION_20GUESS_20FOR_20CONSTRAINT_20MAG}


\index[prmindex]{USE ATOMIC MAGNETIZATION GUESS FOR CONSTRAINT MAG}
\index[prmindexfull]{DFT functional parameters!USE ATOMIC MAGNETIZATION GUESS FOR CONSTRAINT MAG}
{\it Value:} false
...
{\it Description:} [Standard] Use atomic magnetization initial guess from coordinates.inp when using constrained magnetization solve for a set TOTAL MAGNETIZATION. The default value of false sets the initial guess of spin density to be a scaling of the total atomic density. 
...
\subsection{Parameters in section \tt DFT functional parameters/CONFINING POTENTIAL parameters}
\label{parameters:DFT_20functional_20parameters/CONFINING_20POTENTIAL_20parameters}

\begin{itemize}
\item {\it Parameter name:} {\tt APPLY CONFINING POTENTIAL}
\phantomsection\label{parameters:DFT functional parameters/CONFINING POTENTIAL parameters/APPLY CONFINING POTENTIAL}
\label{parameters:DFT_20functional_20parameters/CONFINING_20POTENTIAL_20parameters/APPLY_20CONFINING_20POTENTIAL}


\index[prmindex]{APPLY CONFINING POTENTIAL}
\index[prmindexfull]{DFT functional parameters!CONFINING POTENTIAL parameters!APPLY CONFINING POTENTIAL}
{\it Value:} false
...
{\it Description:} [Advanced] Apply confining potential. Usually required for anionic charges.The confining potential is applied between maxDist + r1 and maxDist + r2. Where maxDist is the maximum distance of atoms from the center. r1 and r2 is the INNER and OUTER radii respectively.Between 0 and maxdist + r1: V(r) = 0;Between maxdist + r1 and maxdist + r2: V(r) = (C*exp(-W/(dist1)))/(dist2*dist2 + 1E-6);Beyond maxdist + r2: V(r) = (C*exp(-W/(dist1)))/(1E-6);where dist1 = r - (maxdist + r1) and dist2 = (maxdist + r2) - r


{\it Possible values:} A boolean value (true or false)
\item {\it Parameter name:} {\tt C PARAM}
\phantomsection\label{parameters:DFT functional parameters/CONFINING POTENTIAL parameters/C PARAM}
\label{parameters:DFT_20functional_20parameters/CONFINING_20POTENTIAL_20parameters/C_20PARAM}


\index[prmindex]{C PARAM}
\index[prmindexfull]{DFT functional parameters!CONFINING POTENTIAL parameters!C PARAM}
{\it Value:} 1.0
...
{\it Description:} [Advanced] The C parameter for the confining potential.


{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq 100$
\item {\it Parameter name:} {\tt INNER RADIUS}
\phantomsection\label{parameters:DFT functional parameters/CONFINING POTENTIAL parameters/INNER RADIUS}
\label{parameters:DFT_20functional_20parameters/CONFINING_20POTENTIAL_20parameters/INNER_20RADIUS}


\index[prmindex]{INNER RADIUS}
\index[prmindexfull]{DFT functional parameters!CONFINING POTENTIAL parameters!INNER RADIUS}
{\it Value:} 17.0
...
{\it Description:} [Advanced] The inner radius (r1) for the confining potential.


{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq 100$
\item {\it Parameter name:} {\tt OUTER RADIUS}
\phantomsection\label{parameters:DFT functional parameters/CONFINING POTENTIAL parameters/OUTER RADIUS}
\label{parameters:DFT_20functional_20parameters/CONFINING_20POTENTIAL_20parameters/OUTER_20RADIUS}


\index[prmindex]{OUTER RADIUS}
\index[prmindexfull]{DFT functional parameters!CONFINING POTENTIAL parameters!OUTER RADIUS}
{\it Value:} 20.0
...
{\it Description:} [Advanced] The outer radius (r2) for the confining potential.


{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq 100$
\item {\it Parameter name:} {\tt W PARAM}
\phantomsection\label{parameters:DFT functional parameters/CONFINING POTENTIAL parameters/W PARAM}
\label{parameters:DFT_20functional_20parameters/CONFINING_20POTENTIAL_20parameters/W_20PARAM}


\index[prmindex]{W PARAM}
\index[prmindexfull]{DFT functional parameters!CONFINING POTENTIAL parameters!W PARAM}
{\it Value:} 1.0
...
{\it Description:} [Advanced] The W parameter for the confining potential.
...
\subsection{Parameters in section \tt DFT functional parameters/Hubbard Parameters}
\label{parameters:DFT_20functional_20parameters/Hubbard_20Parameters}

\begin{itemize}
\item {\it Parameter name:} {\tt HUBBARD PARAMETERS FILE}
\phantomsection\label{parameters:DFT functional parameters/Hubbard Parameters/HUBBARD PARAMETERS FILE}
\label{parameters:DFT_20functional_20parameters/Hubbard_20Parameters/HUBBARD_20PARAMETERS_20FILE}


\index[prmindex]{HUBBARD PARAMETERS FILE}
\index[prmindexfull]{DFT functional parameters!Hubbard Parameters!HUBBARD PARAMETERS FILE}
{\it Value:} 
...
{\it Description:} [Standard] Name of the file containing hubbard parameters. This file describes the orbitals and the hubbard U parameter for each hubbard species. A sample file for Pt-Au dimer is as follows:  3 (row1 - number of hubbard species, The ID 0 is reserved for atoms with no hubbard correction ),0 0 (row2 - Hubbard species Id and the corresponding number of orbitals1 78 0.110248 1 9.0 (row3 - hubbard species Id corresponding to Pt, Atomic number, Hubbard U parameter in Ha, Number of orbitals on which the hubbard correction is applied (5D in this case), The initial occupancy of the orbitals)5 2 (row4 - the Quantum number n and Quantum number l of the orbital)2 79 0.1469976 1 10.0 (row3 - hubbard species Id corresponding to Au, Atomic number, Hubbard U parameter in Ha, Number of orbitals on which the hubbard correction is applied (5D in this case), The initial occupancy of the orbitals)5 2 (row4 - the Quantum number n and Quantum number l of the orbital)78 1 (row5 - the atomic number and the corresponding hubbard species Id. The list has to be copied from the coordinates file79 2 (row6 - the atomic number and the corresponding hubbard species Id. The list has to be copied from the coordinates file
...
\subsection{Parameters in section \tt FunctionalTest}
\label{parameters:FunctionalTest}

\begin{itemize}
\item {\it Parameter name:} {\tt TEST NAME}
\phantomsection\label{parameters:FunctionalTest/TEST NAME}
\label{parameters:FunctionalTest/TEST_20NAME}


\index[prmindex]{TEST NAME}
\index[prmindexfull]{FunctionalTest!TEST NAME}
{\it Value:} 
...
{\it Description:} [Standard] Name of the Functional test that needs to be run.
...
{\it Possible values:} A floating point number $v$ such that $0 \leq v \leq 1$
\item {\it Parameter name:} {\tt VSELF GPU MODE}
\phantomsection\label{parameters:Poisson problem parameters/VSELF GPU MODE}
\label{parameters:Poisson_20problem_20parameters/VSELF_20GPU_20MODE}


\index[prmindex]{VSELF GPU MODE}
\index[prmindexfull]{Poisson problem parameters!VSELF GPU MODE}
{\it Value:} true
...
{\it Description:} [Advanced] Toggle GPU MODE in vself Poisson solve.
...
{\it Description:} [standard] Gaussian smearing temperature (in K) for DOS, PDOS and LDOS calculation
...
{\it Description:} [Standard] Prints the Kinetic energy of the electrons.  Default: false.
...
{\it Description:} [Standard] Computes projected density of states on each atomic orbital using Gaussian smearing. Uses specified 'DOS SMEAR TEMPERATURE' as the broadening parameter. Outputs files with name format 'pdosData\_atom\#\{atom number\}\_wfc\#\{wfc number\}(\{wfc name\}).out'. For colinear, spin-unpolarized case, each of these file contain columns with format 'E sumPDOS  PDOS\_0 .... PDOS\_(2l)', where E: the energy is eV (without shift wrt Fermi energy. Fermi energy can be obtained from the file 'fermiEnergy.out' that is generated when 'SAVE RHO DATA = true' in 'GS' calculation), l: azimuthal quantum number, sumPDOS: PDOS\_0 + .. + PDOS\_(2l). 
For colinear, spin-polarized case, the columns has format 'E sumPDOS\_up sumPDOS\_down PDOS\_0\_up PDOS\_0\_down .... PDOS\_(2l)\_up PDOS\_(2l)\_down', where 'up' and 'down' refer to the spin up and spin down case with all other terms having the same meaning as of the spin-unpolarized case.
...
\begin{itemize}
    \item {\it Parameter name:} {\tt LOAD QUAD DATA}
    \phantomsection\label{parameters:SCF Checkpointing and Restart/LOAD QUAD DATA}
    \label{parameters:SCF_20Checkpointing_20and_20Restart/LOAD_20QUAD_20DATA}
    
    
    \index[prmindex]{LOAD QUAD DATA}
    \index[prmindexfull]{SCF Checkpointing and Restart!LOAD QUAD DATA}
    {\it Value:} true
    ...
    {\it Description:} [Standard] Loads the various variables involved in the SCF fixed point iteration from restart file. Used for NSCF calculations where the quadrature density is required. Default value is false.
...
{\it Possible values:} A boolean value (true or false)
\item {\it Parameter name:} {\tt SAVE QUAD DATA}
\phantomsection\label{parameters:SCF Checkpointing and Restart/SAVE QUAD DATA}
\label{parameters:SCF_20Checkpointing_20and_20Restart/SAVE_20QUAD_20DATA}


\index[prmindex]{SAVE QUAD DATA}
\index[prmindexfull]{SCF Checkpointing and Restart!SAVE QUAD DATA}
{\it Value:} false
...
{\it Description:} [Standard] Saves the various variables involved in the SCF fixed point interation to restart file. Default value is false.
...
{\it Possible values:} A boolean value (true or false)
\item {\it Parameter name:} {\tt PURE STATE}
\phantomsection\label{parameters:SCF parameters/PURE STATE}
\label{parameters:SCF_20parameters/PURE_20STATE}


\index[prmindex]{PURE STATE}
\index[prmindexfull]{SCF parameters!PURE STATE}
{\it Value:} false
...
{\it Description:} [Standard] Explictly solves for a pure Kohn-Sham state instead of an ensemble Kohn-Sham state implemented using Fermi-Dirac smearing. If this parameter is set to true, it overrides the Fermi-Dirac smearing temperature. Default is false.


{\it Possible values:} A boolean value (true or false)
\item {\it Parameter name:} {\tt ENERGY TOLERANCE}
\phantomsection\label{parameters:SCF parameters/ENERGY TOLERANCE}
\label{parameters:SCF_20parameters/ENERGY_20TOLERANCE}


\index[prmindex]{ENERGY TOLERANCE}
\index[prmindexfull]{SCF parameters!ENERGY TOLERANCE}
{\it Value:} 1e-07
...
{\it Possible values:} An integer $n$ such that $0\leq n \leq 2147483647$
\item {\it Parameter name:} {\tt NUMBER OF CORE EIGEN STATES FOR MIXED PREC RR}
\phantomsection\label{parameters:SCF parameters/Eigen_2dsolver parameters/NUMBER OF CORE EIGEN STATES FOR MIXED PREC RR}
\label{parameters:SCF_20parameters/Eigen_2dsolver_20parameters/NUMBER_20OF_20CORE_20EIGEN_20STATES_20FOR_20MIXED_20PREC_20RR}


\index[prmindex]{NUMBER OF CORE EIGEN STATES FOR MIXED PREC RR}
\index[prmindexfull]{SCF parameters!Eigen-solver parameters!NUMBER OF CORE EIGEN STATES FOR MIXED PREC RR}
{\it Value:} 0
...
{\it Possible values:} An integer $n$ such that $1\leq n \leq 2147483647$
\item {\it Parameter name:} {\tt TENSOR OP TYPE SINGLE PREC CHEBY}
\phantomsection\label{parameters:SCF parameters/Eigen_2dsolver parameters/TENSOR OP TYPE SINGLE PREC CHEBY}
\label{parameters:SCF_20parameters/Eigen_2dsolver_20parameters/TENSOR_20OP_20TYPE_20SINGLE_20PREC_20CHEBY}


\index[prmindex]{TENSOR OP TYPE SINGLE PREC CHEBY}
\index[prmindexfull]{SCF parameters!Eigen-solver parameters!TENSOR OP TYPE SINGLE PREC CHEBY}
{\it Value:} FP32
...
{\it Description:} [Advanced] Tensor operation datatype for the modified single precision algorithm for Chebyshev filtering, this only used on Nvidia GPUs with compute capability greater than 80. Default setting is FP32.


{\it Possible values:} Any one of FP32, TF32
\item {\it Parameter name:} {\tt USE APPROXIMATE OVERLAP MATRIX}
\phantomsection\label{parameters:SCF parameters/Eigen_2dsolver parameters/USE APPROXIMATE OVERLAP MATRIX}
\label{parameters:SCF_20parameters/Eigen_2dsolver_20parameters/USE_20APPROXIMATE_20OVERLAP_20MATRIX}


\index[prmindex]{USE APPROXIMATE OVERLAP MATRIX}
\index[prmindexfull]{SCF parameters!Eigen-solver parameters!USE APPROXIMATE OVERLAP MATRIX}
{\it Value:} true
...
{\it Description:} [Standard] Use approximate overlap matrix (diagonal for FE basis overlap).  Default setting is true.
...
{\it Possible values:} A boolean value (true or false)
\item {\it Parameter name:} {\tt USE MIXED PREC COMMUN ONLY XTOX XTHX}
\phantomsection\label{parameters:SCF parameters/Eigen_2dsolver parameters/USE MIXED PREC COMMUN ONLY XTOX XTHX}
\label{parameters:SCF_20parameters/Eigen_2dsolver_20parameters/USE_20MIXED_20PREC_20COMMUN_20ONLY_20XTOX_20XTHX}


\index[prmindex]{USE MIXED PREC COMMUN ONLY XTOX XTHX}
\index[prmindexfull]{SCF parameters!Eigen-solver parameters!USE MIXED PREC COMMUN ONLY XTOX XTHX}
{\it Value:} false
...
{\it Description:} [Advanced] Use mixed precision communication only for XtOX and XtHX instead of mixed precision compute and communication. This setting has been found to be more optimal on certain architectures. Default setting is false.
...
{\it Possible values:} A boolean value (true or false)
\item {\it Parameter name:} {\tt USE MIXED PREC XTHX}
\phantomsection\label{parameters:SCF parameters/Eigen_2dsolver parameters/USE MIXED PREC XTHX}
\label{parameters:SCF_20parameters/Eigen_2dsolver_20parameters/USE_20MIXED_20PREC_20XTHX}


\index[prmindex]{USE MIXED PREC XTHX}
\index[prmindexfull]{SCF parameters!Eigen-solver parameters!USE MIXED PREC XTHX}
{\it Value:} false
...
{\it Description:} [Advanced] Use mixed precision arithmetic in $X^{T}$ Hamiltonian matrix times X computation. Default setting is false.


{\it Possible values:} A boolean value (true or false)
\item {\it Parameter name:} {\tt USE MIXED PREC XTOX}
\phantomsection\label{parameters:SCF parameters/Eigen_2dsolver parameters/USE MIXED PREC XTOX}
\label{parameters:SCF_20parameters/Eigen_2dsolver_20parameters/USE_20MIXED_20PREC_20XTOX}


\index[prmindex]{USE MIXED PREC XTOX}
\index[prmindexfull]{SCF parameters!Eigen-solver parameters!USE MIXED PREC XTOX}
{\it Value:} false
...
{\it Description:} [Advanced] Use mixed precision arithmetic in $X^{T}$ Overlap matrix times X computation. Default setting is false.


{\it Possible values:} A boolean value (true or false)
\item {\it Parameter name:} {\tt USE RESIDUAL CHFSI}
\phantomsection\label{parameters:SCF parameters/Eigen_2dsolver parameters/USE RESIDUAL CHFSI}
\label{parameters:SCF_20parameters/Eigen_2dsolver_20parameters/USE_20RESIDUAL_20CHFSI}


\index[prmindex]{USE RESIDUAL CHFSI}
\index[prmindexfull]{SCF parameters!Eigen-solver parameters!USE RESIDUAL CHFSI}
{\it Value:} true
...
{\it Description:} [Advanced] Builds the Chebyshev filtered subspace in full precision based on a residual equation. To be used when USE APPROXIMATE OVERLAP MATRIX is set to false.


{\it Possible values:} A boolean value (true or false)
\item {\it Parameter name:} {\tt USE SINGLE PREC CHEBY}
\phantomsection\label{parameters:SCF parameters/Eigen_2dsolver parameters/USE SINGLE PREC CHEBY}
...
\phantomsection\label{parameters:SCF parameters/Eigen_2dsolver parameters/USE SINGLE PREC COMMUN CHEBY}
