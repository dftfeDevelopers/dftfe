...
\phantomsection\label{parameters:DFT functional related parameters/PSEUDOPOTENTIAL FILE NAMES LIST}
...
\index[prmindexfull]{DFT functional related parameters!PSEUDOPOTENTIAL FILE NAMES LIST}
...
\phantomsection\label{parameters:DFT functional related parameters/PSEUDO TESTS FLAG}
\label{parameters:DFT_20functional_20related_20parameters/PSEUDO_20TESTS_20FLAG}


\index[prmindex]{PSEUDO TESTS FLAG}
\index[prmindexfull]{DFT functional related parameters!PSEUDO TESTS FLAG}
...
\phantomsection\label{parameters:SCF parameters/Eigen_2dsolver_2fChebyshev solver related parameters/LOWER BOUND UNWANTED FRAC UPPER}
...
\index[prmindexfull]{SCF parameters!Eigen-solver/Chebyshev solver related parameters!LOWER BOUND UNWANTED FRAC UPPER}
...
\phantomsection\label{parameters:SCF parameters/Eigen_2dsolver_2fChebyshev solver related parameters/SCALAPACKPROCS}
...
\index[prmindexfull]{SCF parameters!Eigen-solver/Chebyshev solver related parameters!SCALAPACKPROCS}
