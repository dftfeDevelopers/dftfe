  ...
  namespace linearAlgebraOperationsDevice
  {
      ...
      const dftParameters &                          dftParams)
    {
      ...
      */
      ...
      daxpyDeviceKernel<<<min((totalVectorSize + 255) / 256, 30000), 256>>>(
      ...
      */
      ...
      dscalDeviceKernel<<<min((totalVectorSize + 255) / 256, 30000), 256>>>(
      ...
      for (unsigned int degree = 2; degree < m + 1; ++degree)
        {
          ...
          if (degree == 2)
            {
              daxpbyDeviceKernel<<<min((totalVectorSize + 255) / 256, 30000),
                                   256>>>(
              ...
              //
              scaleDeviceKernel<<<(numberVectors + 255) / 256 * localVectorSize,
                                  256>>>(numberVectors,
                                         localVectorSize,
                                         alpha1,
                                         YArray.begin(),
            ...
            {
              combinedDeviceKernel<<<min((totalVectorSize + 255) / 256, 30000),
                                     256>>>(numberVectors,
                                            localVectorSize,
                                            YArray.begin(),
                                            XArray.begin(),
      ...
      for (unsigned int jvec = 0; jvec < N; jvec += vectorsBlockSize)
        {
          ...
          if (((jvec + B) <=
              ...
              !useBandParal)
            {
              ...
              computeResidualDeviceKernel<<<(B + 255) / 256 * M, 256>>>(
                B,
                M,
                N,
                jvec,
