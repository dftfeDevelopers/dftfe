...
#pragma unroll
  ...
  template void
  computeAXDevicePoisson<double, 9, 3, 3, 3>(const int,
                                             const int,
                                             const int,
                                             double *,
                                             const double *,
                                             ...
                                             const int *);
  template void
  computeAXDevicePoisson<double, 16, 4, 4, 3>(const int,
                                              const int,
                                              const int,
                                              double *,
                                              const double *,
                                              ...
                                              const int *);
  template void
  computeAXDevicePoisson<double, 25, 5, 5, 3>(const int,
                                              const int,
                                              const int,
                                              double *,
                                              const double *,
                                              ...
                                              const int *);
  template void
  computeAXDevicePoisson<double, 36, 6, 6, 3>(const int,
                                              const int,
                                              const int,
                                              double *,
                                              const double *,
                                              ...
                                              const int *);
  template void
  computeAXDevicePoisson<double, 49, 7, 7, 3>(const int,
                                              const int,
                                              const int,
                                              double *,
                                              const double *,
                                              ...
                                              const int *);
  template void
  computeAXDevicePoisson<double, 64, 8, 8, 3>(const int,
                                              const int,
                                              const int,
                                              double *,
                                              const double *,
                                              ...
                                              const int *);
  template void
  computeAXDevicePoisson<double, 81, 9, 9, 3>(const int,
                                              const int,
                                              const int,
                                              double *,
                                              const double *,
                                              ...
                                              const int *);
  template void
  computeAXDevicePoisson<double, 100, 10, 10, 3>(const int,
                                                 const int,
                                                 const int,
                                                 double *,
                                                 const double *,
...
#else
  template void
  computeAXDevicePoisson<double, 4, 2, 2, 3>(const int,
                                             const int,
                                             const int,
                                             double *,
                                             const double *,
  ...
  computeAXDevicePoisson<double, 100, 10, 10, 3>(const int,
                                                 ...
                                                 const int *);
  template void
  computeAXDevicePoisson<double, 121, 11, 11, 3>(const int,
                                                 const int,
                                                 const int,
                                                 double *,
                                                 const double *,
                                                 ...
                                                 const int *);
  template void
  computeAXDevicePoisson<double, 144, 12, 12, 3>(const int,
                                                 const int,
                                                 const int,
                                                 double *,
                                                 const double *,
                                                 ...
                                                 const int *);
  template void
  computeAXDevicePoisson<double, 169, 13, 13, 3>(const int,
                                                 const int,
                                                 const int,
                                                 double *,
                                                 const double *,
                                                 ...
                                                 const int *);
  template void
  computeAXDevicePoisson<double, 196, 14, 14, 3>(const int,
                                                 const int,
                                                 const int,
                                                 double *,
                                                 const double *,
                                                 ...
                                                 const int *);
  template void
  computeAXDevicePoisson<double, 225, 15, 15, 3>(const int,
                                                 const int,
                                                 const int,
                                                 double *,
                                                 const double *,
                                                 ...
                                                 const int *);
  template void
  computeAXDevicePoisson<double, 256, 16, 16, 3>(const int,
                                                 const int,
                                                 const int,
                                                 double *,
                                                 const double *,
                                                 ...
                                                 const int *);
  template void
  computeAXDevicePoisson<double, 289, 17, 17, 3>(const int,
                                                 const int,
                                                 const int,
                                                 double *,
                                                 const double *,
...
#endif
  template void
  computeAXDeviceHelmholtz<double, 4, 2, 2, 3>(const int,
                                               const int,
                                               const int,
                                               double *,
                                               const double *,
                                               ...
                                               const double);
  template void
  computeAXDeviceHelmholtz<double, 9, 3, 3, 3>(const int,
                                               const int,
                                               const int,
                                               double *,
                                               const double *,
                                               ...
                                               const double);
  template void
  computeAXDeviceHelmholtz<double, 16, 4, 4, 3>(const int,
                                                const int,
                                                const int,
                                                double *,
                                                const double *,
                                                ...
                                                const double);
  template void
  computeAXDeviceHelmholtz<double, 25, 5, 5, 3>(const int,
                                                const int,
                                                const int,
                                                double *,
                                                const double *,
                                                ...
                                                const double);
  template void
  computeAXDeviceHelmholtz<double, 36, 6, 6, 3>(const int,
                                                const int,
                                                const int,
                                                double *,
                                                const double *,
                                                ...
                                                const double);
  template void
  computeAXDeviceHelmholtz<double, 49, 7, 7, 3>(const int,
                                                const int,
                                                const int,
                                                double *,
                                                const double *,
                                                ...
                                                const double);
  template void
  computeAXDeviceHelmholtz<double, 64, 8, 8, 3>(const int,
                                                const int,
                                                const int,
                                                double *,
                                                const double *,
                                                ...
                                                const double);
  template void
  computeAXDeviceHelmholtz<double, 81, 9, 9, 3>(const int,
                                                const int,
                                                const int,
                                                double *,
                                                const double *,
                                                ...
                                                const double);
  template void
  computeAXDeviceHelmholtz<double, 100, 10, 10, 3>(const int,
                                                   const int,
                                                   const int,
                                                   double *,
                                                   const double *,
                                                   ...
                                                   const double);
  template void
  computeAXDeviceHelmholtz<double, 121, 11, 11, 3>(const int,
                                                   const int,
                                                   const int,
                                                   double *,
                                                   const double *,
                                                   ...
                                                   const double);
  template void
  computeAXDeviceHelmholtz<double, 144, 12, 12, 3>(const int,
                                                   const int,
                                                   const int,
                                                   double *,
                                                   const double *,
                                                   ...
                                                   const double);
  template void
  computeAXDeviceHelmholtz<double, 169, 13, 13, 3>(const int,
                                                   const int,
                                                   const int,
                                                   double *,
                                                   const double *,
                                                   ...
                                                   const double);
  template void
  computeAXDeviceHelmholtz<double, 196, 14, 14, 3>(const int,
                                                   const int,
                                                   const int,
                                                   double *,
                                                   const double *,
                                                   ...
                                                   const double);
  template void
  computeAXDeviceHelmholtz<double, 225, 15, 15, 3>(const int,
                                                   const int,
                                                   const int,
                                                   double *,
                                                   const double *,
                                                   ...
                                                   const double);
  template void
  computeAXDeviceHelmholtz<double, 256, 16, 16, 3>(const int,
                                                   const int,
                                                   const int,
                                                   double *,
                                                   const double *,
                                                   ...
                                                   const double);
  template void
  computeAXDeviceHelmholtz<double, 289, 17, 17, 3>(const int,
                                                   const int,
                                                   const int,
                                                   double *,
                                                   const double *,
