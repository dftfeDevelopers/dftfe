...
namespace dftfe
{
	namespace CUDA
	{
       ...
       const unsigned int matrixFreeDofhandlerIndex,
         ...
         const unsigned int remCellBlockSize=totalLocallyOwnedCells-numCellBlocks*cellsBlockSize;
         ...
         for (unsigned int jvec = 0; jvec < totalNumWaveFunctions; jvec += BVec)
         {
               ...
               (jvec+BVec)>bandGroupLowHighPlusOneIndices[2*bandGroupTaskId])
           {
             ...
             {
               const unsigned int currentCellsBlockSize= (iblock==numCellBlocks)?remCellBlockSize:cellsBlockSize;
               if (currentCellsBlockSize>0)
               {
                 const unsigned int startingCellId=iblock*cellsBlockSize; 

                 copyCUDAKernel<<<(BVec+255)/256*currentCellsBlockSize*numNodesPerElement,256>>>
                   (BVec,
                    currentCellsBlockSize*numNodesPerElement,
                    cudaFlattenedArrayBlock.begin(),
                    thrust::raw_pointer_cast(&cellWaveFunctionMatrix[0]),
                    thrust::raw_pointer_cast(&(operatorMatrix.getFlattenedArrayCellLocalProcIndexIdMap()[startingCellId*numNodesPerElement])));
                 ...
                 if(isEvaluateGradRho)
                 {
                   ...
                   cublasDgemmStridedBatched(operatorMatrix.getCublasHandle(),
                       ...
                       BVec,
                       strideA,
                       thrust::raw_pointer_cast(&(operatorMatrix.getShapeFunctionGradientValuesXInverted(use2pPlusOneGLQuad)[startingCellId*numNodesPerElement*numQuadPoints])),
                       numNodesPerElement,
                       strideB,
                       &scalarCoeffBeta,
                   ...
                   cublasDgemmStridedBatched(operatorMatrix.getCublasHandle(),
                       ...
                       BVec,
                       strideA,
                       thrust::raw_pointer_cast(&(operatorMatrix.getShapeFunctionGradientValuesYInverted(use2pPlusOneGLQuad)[startingCellId*numNodesPerElement*numQuadPoints])),
                       numNodesPerElement,
                       strideB,
                       &scalarCoeffBeta,
                   ...
                   cublasDgemmStridedBatched(operatorMatrix.getCublasHandle(),
                       ...
                       BVec,
                       strideA,
                       thrust::raw_pointer_cast(&(operatorMatrix.getShapeFunctionGradientValuesZInverted(use2pPlusOneGLQuad)[startingCellId*numNodesPerElement*numQuadPoints])),
                       numNodesPerElement,
                       strideB,
                       &scalarCoeffBeta,
                 ...
                 computeRhoGradRhoFromInterpolatedValues<<<(BVec+255)/256*numQuadPoints*currentCellsBlockSize, 256>>>
                 ...
                 cublasDgemm(operatorMatrix.getCublasHandle(),
                     ...
                     BVec,
                     &scalarCoeffBetaRho,
                     thrust::raw_pointer_cast(&rhoDevice[startingCellId*numQuadPoints]),
                     1);
                 ...
                 if(isEvaluateGradRho)
                 {
                   ...
                   cublasDgemm(operatorMatrix.getCublasHandle(),
                       ...
                       thrust::raw_pointer_cast(&gradRhoDeviceX[startingCellId*numQuadPoints]),
                       1);
                   ...
                   cublasDgemm(operatorMatrix.getCublasHandle(),
                       ...
                       BVec,
                       &scalarCoeffBetaGradRho,
                       thrust::raw_pointer_cast(&gradRhoDeviceY[startingCellId*numQuadPoints]),
                       1);
                   ...
                   cublasDgemm(operatorMatrix.getCublasHandle(),
                       ...
                       BVec,
                       &scalarCoeffBetaGradRho,
                       thrust::raw_pointer_cast(&gradRhoDeviceZ[startingCellId*numQuadPoints]),
                       1);
               ...
               for (int iblock=0; iblock<(numCellBlocks+1); iblock++)
               {
                 ...
                 if (currentCellsBlockSize>0)
                 {
                   ...
                   cublasDgemm(operatorMatrix.getCublasHandle(),
                       ...
                       BVec,
                       &scalarCoeffBetaRho,
                       thrust::raw_pointer_cast(&rhoSpinPolarizedDevice[startingCellId*numQuadPoints]),
                       1);
                   ...
                   if(isEvaluateGradRho)
                   {
                     ...
                     cublasDgemm(operatorMatrix.getCublasHandle(),
                         ...
                         BVec,
                         &scalarCoeffBetaGradRho,
                         thrust::raw_pointer_cast(&gradRhoSpinPolarizedDeviceX[startingCellId*numQuadPoints]),
                         1);
                     ...
                     cublasDgemm(operatorMatrix.getCublasHandle(),
                         ...
                         BVec,
                         &scalarCoeffBetaGradRho,
                         thrust::raw_pointer_cast(&gradRhoSpinPolarizedDeviceY[startingCellId*numQuadPoints]),
                         1);
                     ...
                     cublasDgemm(operatorMatrix.getCublasHandle(),
                         ...
                         BVec,
                         &scalarCoeffBetaGradRho,
                         thrust::raw_pointer_cast(&gradRhoSpinPolarizedDeviceZ[startingCellId*numQuadPoints]),
                         1);
