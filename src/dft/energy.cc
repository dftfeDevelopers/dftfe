	  ...
	  if (cell->is_locally_owned())
	    {
	      ...
	      fe_values.get_function_values(d_phiTotRhoIn,cellPhiTotRhoIn);
	      fe_values.get_function_values(d_phiTotRhoOut,cellPhiTotRhoOut);
	      fe_values.get_function_values(d_phiExt,cellPhiExt);
