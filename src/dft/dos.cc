				     ...
				     const std::string & dosFileName)
{
  ...
  std::vector<double> densityOfStates(numberIntervals,0.0);
				     ...
				     const std::string & ldosFileName)
{
  ...
  std::vector<double> localDensityOfStates(numberGlobalAtoms*numberIntervals,0.0);
