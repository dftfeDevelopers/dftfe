...
namespace dftfe
{
  namespace linearAlgebra
  {
    ...
    BLASWrapper<dftfe::utils::MemorySpace::DEVICE>::xaxpy(
      ...
      const dftfe::uInt incy) const
    {
      dftfe::utils::deviceBlasStatus_t status = cublasDaxpy(d_deviceBlasHandle,
                                                            dftfe::Int(n),
                                                            alpha,
                                                            x,
                                                            dftfe::Int(incx),
      ...
      double           *result) const
    {
      ...
      *result                                 = 0.0;
      dftfe::utils::deviceBlasStatus_t status = cublasDdot(d_deviceBlasHandle,
                                                           dftfe::Int(N),
                                                           X,
                                                           dftfe::Int(INCX),
                                                           Y,
      ...
      double           *result) const
    {
      double localresult                      = 0.0;
      *result                                 = 0.0;
      dftfe::utils::deviceBlasStatus_t status = cublasDnrm2(
