...
namespace dftfe
{
  namespace linearAlgebra
  {
    ...
    {
      deviceBlasStatus_t status = cublasSgemm(d_deviceBlasHandle,
                                              transA,
                                              transB,
                                              m,
                                              n,
    ...
    BLASWrapperClass<dftfe::utils::MemorySpace::DEVICE>::xgemm(
      ...
      const unsigned int *ldc)
    {
      deviceBlasStatus_t status = cublasDgemm(d_deviceBlasHandle,
                                              transA,
                                              transB,
                                              m,
                                              n,
    ...
    {
      deviceBlasStatus_t status = cublasCreate(d_deviceBlasHandle);
      DEVICEBLAS_API_CHECK(status);
      return status;
    }
    ...
    {
      deviceBlasStatus_t status = cublasDestroy(d_deviceBlasHandle);
      DEVICEBLAS_API_CHECK(status);
      return status;
    }
    ...
    {
      deviceBlasStatus_t status = cublasSetStream(d_deviceBlasHandle, stream);
      DEVICEBLAS_API_CHECK(status);
      return status;
    }
