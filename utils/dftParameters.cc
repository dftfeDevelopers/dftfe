  ...
  void declare_parameters(ParameterHandler &prm)
  {
	...
	prm.enter_subsection ("Eigen-solver parameters");
	{
	    ...
	    prm.declare_entry("RR GEP FULL MASS MATRIX", "false",
			      Patterns::Bool(),"[Advanced] Solve generalized eigenvalue problem instead of standard eignevalue problem in Rayleigh-Ritz step with finite-element overlap matrix evaluated using full quadrature rule (Gauss quadrature rule) only during the solution of the generalized eigenvalue problem in the RR step.  Default value is false and is only active when RR GEP is true.");
