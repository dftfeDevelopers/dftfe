...
srun -n 6 -c 7 --gpu-bind closest $BASE/dftfe parameterFileCubicFe_scf.prm > outputCubicFe_scf
srun -n 6 -c 7 --gpu-bind closest $BASE/dftfe parameterFileCubicFe_pdos.prm > outputCubicFe_pdos
