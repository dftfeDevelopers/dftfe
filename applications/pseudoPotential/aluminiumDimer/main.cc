...
//Mesh information
//
#define meshFileName "../../../data/meshes/pseudoPotential/aluminumDimer/mesh.inp"
#define coordinatesFile "../../../data/meshes/pseudoPotential/aluminumDimer/coordinates.inp" 
