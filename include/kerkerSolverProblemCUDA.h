...
#  ifndef kerkerSolverProblemCUDA_H_
#    define kerkerSolverProblemCUDA_H_
...
namespace dftfe
{
  ...
  class kerkerSolverProblemCUDA : public linearSolverProblemCUDA
  {
  public:
    /// Constructor
    kerkerSolverProblemCUDA(const MPI_Comm &mpi_comm_parent,
...
#  endif // kerkerSolverProblemCUDA_H_
#endif
