...
namespace dftfe
{
  extern "C"
  {
     ...
     * different processes. Because of this, it is possible that a heterogeneous
     ...
     * It is not required that the matrices A and B have the same process grid
     * or block size, e.g. copying a matrix from a one-dimensional to a
