// ---------------------------------------------------------------------
//
// Copyright (c) 2018-2019  The Regents of the University of Michigan and DFT-FE authors.
//
...
#ifndef cgLinearSolverCUDA_H_
#define cgLinearSolverCUDA_H_
...
namespace dftfe {
   ...
   * @author Sambit Das
   */
  class cgLinearSolverCUDA : public linearSolverCUDA
  {
  public:
     ...
     */
    cgLinearSolverCUDA(const  MPI_Comm &mpi_comm,
     ...
     *                   2 - all debug output.
     */
    void solve(linearSolverProblemCUDA & problem,
