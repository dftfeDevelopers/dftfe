...
namespace
{
  ...
  cgd_value(double *x, INT n)
  {
    ...
    MPI_Bcast(&solutionInc[0],
              ...
              MPI_DOUBLE,
              0,
              functionToBeMinimized->getMPICommunicator());
  ...
  inline void
  cgd_gradient(double *g, double *x, INT n)
  {
  ...
  inline double
  cgd_value_gradient(double *g, double *x, INT n)
  {
    // pele::Array<double> xarray(x, (size_t) n);
    // pele::Array<double> garray(g, (size_t) n);
    ++glob_nfev;
  ...
  inline int
  cgd_test_callback(double f, double *x, double *g, INT n, void *user_data);
...
namespace dftfe
{
  ...
  public:
    ...
    virtual bool
    test_convergence(double              energy,
                     std::vector<double> x,
                     std::vector<double> g)
    {
      return false;
    ...
    // run
    inline bool
    run(nonlinearSolverProblem &problem)
    {
    ...
    inline void
    set_PrintLevel(int val)
    {
      m_parm.PrintLevel = val;
    }
    /* abort cg after maxit iterations */
    inline void
    set_maxit(size_t val)
    {
      m_parm.maxit = (INT)val;
    }
    /* number of vectors stored in memory */
    inline void
    set_memory(int memory)
    {
      m_parm.memory = memory;
    }
    ...
    inline void
    set_AWolfeFac(double val)
    {
      m_parm.AWolfeFac = val;
    }
    inline void
    set_AWolfe(bool val)
    {
      m_parm.AWolfe = (int)val;
    }
    /* T => use LBFGS
    ...
    inline void
    set_StopRule(bool val)
    {
      m_parm.StopRule = (int)val;
    }
    inline void
    set_StopFac(double val)
    {
      m_parm.StopFac = val;
    }

    inline void
    set_x(std::vector<double> &x)
    {
      m_x  = x;
      m_x0 = m_x;
    }
    ...
    inline void
    set_PertRule(bool val)
    {
      m_parm.PertRule = (int)val;
    }
    inline void
    set_eps(double val)
    {
    ...
    set_debug(bool val)
    {
      m_parm.debug = (int)val;
    }
    inline void
    set_debugtol(double val)
    {
      m_parm.debugtol = val;
    }
    ...
    inline void
    set_restart_fac(double val)
    {
      m_parm.restart_fac = val;
    }
    ...
    inline void
    set_nan_rho(double val)
    {
      m_parm.nan_rho = val;
    }
    /* after encountering nan, decay factor for stepsize */
    inline void
    set_nan_decay(double val)
    {
      m_parm.nan_decay = val;
    }

    /*============================================================================
      CG_DESCENT6.8 technical parameters which the user probably should not
      touch
      ----------------------------------------------------------------------------*/
    /* Wolfe line search parameter */
    inline void
    set_delta(double val)
    {
      m_parm.delta = val;
    }
    /* Wolfe line search parameter */
    inline void
    set_sigma(double val)
    {
      m_parm.sigma = val;
    }
    /* decay factor for bracket interval width */
    inline void
    set_gamma(double val)
    {
      m_parm.gamma = val;
    }
    ...
    inline void
    set_psi_lo(double val)
    {
      m_parm.psi_lo = val;
    }
    inline void
    set_psi_hi(double val)
    {
      m_parm.psi_hi = val;
    }
    ...
    inline void
    set_AdaptiveBeta(bool val)
    {
      m_parm.AdaptiveBeta = (int)val;
    }
    /* lower bound factor for beta */
    inline void
    set_BetaLower(double val)
    {
      m_parm.BetaLower = val;
    }
    /* parameter describing the cg_descent family */
    inline void
    set_theta(double val)
    {
      m_parm.theta = val;
    }
    ...
    get_IterSub()
    {
      return m_stats.IterSub;
    }
    /* total number subspaces */
    inline size_t
    get_NumSub()
    {
      return m_stats.NumSub;
    }
    /* number of function evaluations */
    inline size_t
    get_nfunc()
    {
      return m_stats.nfunc;
    }
    /* number of gradient evaluations */
    inline size_t
    get_ngrad()
    {
      return m_stats.ngrad;
    }
          ...
          switch (cgout)
            {
              ...
              case 2:
                ...
                break;
              case 3:
                std::cout << "slope always negative in line search"
                          << std::endl;
                break;
              case 4:
                std::cout << "number secant iterations exceed nsecant"
                          << std::endl;
                break;
              case 5:
                std::cout << "search direction not a descent direction"
                          << std::endl;
                break;
              case 6:
                std::cout << "line search fails in initial interval"
                          << std::endl;
                break;
              case 7:
                ...
                break;
              case 8:
                std::cout << "line search fails during interval update"
                          << std::endl;
                break;
              case 9:
