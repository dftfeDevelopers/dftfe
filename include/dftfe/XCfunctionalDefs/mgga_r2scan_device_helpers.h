// ============================================================
// AUTO-EXTRACTED device-helper fragment (r2SCAN).
...
//   - the MGGA_X/C_R2SCAN_* computation macros (XCfunctionalDefs headers)
//   - the tzk0/tvrho0/... locals provided by the evaluator BODY macros
// The trailing MGGA_X/C_R2SCAN redefinitions remap those macros to call
// the helpers below, and must be in effect before the .def is included.
// ============================================================
#ifndef DFTFE_MGGA_R2SCAN_DEVICE_HELPERS_H
                          ...
                          double tau1)
{
  ...
  double t792 = -t509 + t516 - t523 - 0.54878743191129263322e-1 * t527 * t531 -
                          ...
                          double tau1)
{
  ...
  double t826 =
    0.3e1 / 0.1e2 * t313 * (0.5e1 / 0.3e1 * t807 + 0.5e1 / 0.3e1 * t811) - t825;
  ...
  double t860 =
    my_piecewise5(t323,
                  t838,
                  t331,
                  -0.64e0 * t839 - 0.8704e0 * t841 - 0.4607056813647e1 * t843 +
                    0.122462410087e2 * t845 - 0.957855118103e1 * t847 +
                    0.3101306810232e1 * t849 - 0.362942158544e0 * t343 * t839,
                          ...
                          double tau1)
{
  ...
  double t983 = -t509 + t516 - t523 - 0.54878743191129263322e-1 * t527 * t924 -
...
{
  double t1040 =
    mgga_c_r2scan_vrho1__t1040(rho0, rho1, sigma0, sigma1, sigma2, tau0, tau1);
  double t354 =
  ...
  double t1046 = t381 + t404 - t408 - t412 + t900 + t459 + t902 - t466 - t470 +
...
{
  double t1046 =
    mgga_c_r2scan_vrho1__t1046(rho0, rho1, sigma0, sigma1, sigma2, tau0, tau1);
  double t1046v = t1046;
  return t1046v;
}
...
{
  double t1046v =
    mgga_c_r2scan_vrho1__t1046v(rho0, rho1, sigma0, sigma1, sigma2, tau0, tau1);
  double t252 =
    mgga_c_r2scan_vrho1__t252(rho0, rho1, sigma0, sigma1, sigma2, tau0, tau1);
  double t354 =
    mgga_c_r2scan_vrho1__t354(rho0, rho1, sigma0, sigma1, sigma2, tau0, tau1);
...
#endif // DFTFE_MGGA_R2SCAN_DEVICE_HELPERS_H
