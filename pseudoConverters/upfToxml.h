...
//
//
// This header file is for upfToxml.cc adapted from upf2qso.C which is a part of
// Qbox
...
namespace dftfe
{
   ...
   *
   *  The functionality reads the upfile and identifies appropriate tags and
   * converts into xml file format
   *
  ...
  namespace pseudoUtils
  {
     ...
     * @param nlccFlag flag indicating the nonlinear core-correction
     *
