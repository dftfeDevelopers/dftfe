...
dft-fe is a C++ based code for material modeling from first principles using Kohn-Sham density functional theory.
...
Getting started:
*********************************************
dft-fe requires deal.II compiled with p4est, petsc, slepc, alglib and libxc to be pre-installed. Refer to install.txt
